<div class="site-header js-site-header">
    <div class="site-header__container">
        ...
        <div class="site-header__link">
            <a class="js-site-header-link" href="#">Article</a>
        </div>
        <div class="site-header__link">
            <a class="js-site-header-link" href="#">Event</a>
        </div>
        <div class="site-header__link">
            <a class="js-site-header-link" href="#">
                <img class="site-header__site-logo" src="{{ $uniLogo or '/img/component/university/RMITLogo.png' }}" alt="Site logo" />
            </a>
        </div>
        <div class="site-header__link">
            <a class="js-site-header-link" href="{{ env('APP_URL') }}/#universities">Universities</a>
        </div>
        <div class="site-header__link">
            <a class="js-site-header-link" href="#">Forum</a>
        </div>
        <div class="site-header__link">
